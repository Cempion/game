...
piece_data: # stores the block data of each piece, used for rendering and collision
    ...
    .byte DWALL, DWALL, DWALL, DWALL, DWALL, DOPEN, DOPEN, DOPEN, DWALL, DWALL, DOPEN, DWALL, DWALL, DWALL, DWALL, DWALL
    .byte DWALL, DWALL, DWALL, DWALL, DWALL, DOPEN, DOPEN, DOPEN, DOPEN, DWALL, DWALL, DWALL, DWALL, DWALL, DWALL, DWALL
    .byte DWALL, DWALL, DWALL, DWALL, DWALL, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DWALL, DWALL, DWALL, DWALL, DWALL, DWALL
    .byte DWALL, DWALL, DWALL, DWALL, DWALL, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DWALL, DWALL, DWALL, DWALL, DWALL
    .byte DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN
    .byte DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN
    .byte DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN, DOPEN
...
blocks: .byte 3 # stores each block data
    ...
    #           |    |  | |
    .word 0b0001100010000000 # OPEN
    #                     |
    .word 0b0000000000000011 # WALL
